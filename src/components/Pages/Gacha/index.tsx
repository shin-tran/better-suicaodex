...
export default function Gacha() {
  ...
  return (
    <div className="flex flex-col space-y-5 py-3">
      {/* Header Section */}
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-indigo-500/10 to-purple-500/10 dark:from-indigo-500/20 dark:to-purple-500/20 py-6 px-4">
        ...
        <div className="relative z-10 text-center space-y-5 max-w-3xl mx-auto">
          ...
          {/* <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Chọn game để thỏa mãn cơn nghiện gacha nào!
          </p> */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="group relative bg-gradient-to-br from-sky-50 to-indigo-100 dark:from-sky-950 dark:to-indigo-900 rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-sky-200 dark:border-sky-800">
          ...
          <div className="p-5 space-y-3">
            <h3 className="text-xl font-bold text-sky-800 dark:text-sky-300">
              Blue Archive
            </h3>
